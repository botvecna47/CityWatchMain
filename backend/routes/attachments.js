...
const { uploadFiles, getAttachments, getAttachment, deleteAttachment } = require('../controllers/attachmentsController');
...
router.post('/:reportId/upload', upload.array('files', 5), handleUploadError, uploadFiles);
