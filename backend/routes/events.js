...
const { eventUpload, handleEventUploadError } = require('../middleware/eventUpload');
const {
  createEvent,
  getEvents,
  getEventById,
...
router.post('/', authMiddleware, eventUpload.single('image'), handleEventUploadError, createEvent); // Create event
